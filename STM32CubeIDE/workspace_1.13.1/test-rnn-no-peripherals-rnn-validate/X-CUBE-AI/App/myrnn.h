...
#include "myrnn_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_MYRNN_MODEL_NAME          "myrnn"
#define AI_MYRNN_ORIGIN_MODEL_NAME   "rnn_model"

/******************************************************************************/
#define AI_MYRNN_ACTIVATIONS_ALIGNMENT   (4)
#define AI_MYRNN_INPUTS_IN_ACTIVATIONS   (4)
#define AI_MYRNN_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_MYRNN_IN_NUM        (1)

AI_DEPRECATED
#define AI_MYRNN_IN \
  ai_myrnn_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_MYRNN_IN_SIZE { \
  AI_MYRNN_IN_1_SIZE, \
}
#define AI_MYRNN_IN_SIZE_BYTES { \
  AI_MYRNN_IN_1_SIZE_BYTES, \
}
#define AI_MYRNN_IN_1_FORMAT      AI_BUFFER_FORMAT_FLOAT
#define AI_MYRNN_IN_1_HEIGHT      (50)
#define AI_MYRNN_IN_1_CHANNEL     (1)
#define AI_MYRNN_IN_1_SIZE        (50 * 1)
#define AI_MYRNN_IN_1_SIZE_BYTES  (200)

/******************************************************************************/
#define AI_MYRNN_OUT_NUM       (1)

AI_DEPRECATED
#define AI_MYRNN_OUT \
  ai_myrnn_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_MYRNN_OUT_SIZE { \
  AI_MYRNN_OUT_1_SIZE, \
}
#define AI_MYRNN_OUT_SIZE_BYTES { \
  AI_MYRNN_OUT_1_SIZE_BYTES, \
}
#define AI_MYRNN_OUT_1_FORMAT      AI_BUFFER_FORMAT_FLOAT
#define AI_MYRNN_OUT_1_CHANNEL     (1)
#define AI_MYRNN_OUT_1_SIZE        (1)
#define AI_MYRNN_OUT_1_SIZE_BYTES  (4)

/******************************************************************************/
#define AI_MYRNN_N_NODES (3)
 ...
 * @ref ai_myrnn_create. Both the activations memory buffer 
 ...
 */
AI_API_ENTRY
ai_buffer* ai_myrnn_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_MYRNN_*
 * defines into file @ref myrnn.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
