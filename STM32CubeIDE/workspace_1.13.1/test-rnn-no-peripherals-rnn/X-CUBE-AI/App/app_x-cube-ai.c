...
AI_ALIGNED(32)
static uint8_t pool0[AI_MYRNN_DATA_ACTIVATION_1_SIZE];
...
{
//    MX_UARTx_Init();		// xzl, already init'd. no need
...
static const ai_network_entry_t networks[AI_MNETWORK_NUMBER] = {
    {
        .name = (const char *)AI_MYRNN_MODEL_NAME,
        .config = AI_MYRNN_DATA_CONFIG,
        .ai_get_report = ai_myrnn_get_report,
        .ai_create = ai_myrnn_create,
        .ai_destroy = ai_myrnn_destroy,
        .ai_get_error = ai_myrnn_get_error,
        .ai_init = ai_myrnn_init,
        .ai_run = ai_myrnn_run,
        .ai_forward = ai_myrnn_forward,
        .ai_data_params_get = ai_myrnn_data_params_get,
