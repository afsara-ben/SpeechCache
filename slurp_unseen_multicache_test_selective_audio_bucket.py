...
if unseen:
    # folder_path = os.path.join(pwd, f'models/SLURP/slurp_unseen_multicache_selective_audio_bucket')
    folder_path = os.path.join(pwd, 'models/SLURP/curated-slurp-headset-base-audio-bucket-unseen')
else:
    print('---------------------------------EVAL FOR 70% SEEN ------------------------------')
    # folder_path = os.path.join(pwd, f'models/SLURP/slurp_70%_multicache_selective_audio_bucket')
    folder_path = os.path.join(pwd, 'models/SLURP/curated-slurp-headset-base-audio-bucket-70%-seen')
...
for _, user_id in tqdm(enumerate(speakers), total=len(speakers)):
    ...
    for bucket in buckets:
        if unseen:
            ...
            filename = f'slurp_curated_headset_base_70%_seen_{user_id}_audio_bucket_{bucket}'
